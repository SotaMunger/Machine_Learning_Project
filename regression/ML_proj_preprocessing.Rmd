...
regression_df <- left_join(statement_df, transaction1_df, by=c("customer_id"="customer_id"))
...
final_df <- subset(final_df, select = -c(X,Branch_ID,Branch_X,Branch_Y,Home_Loc_X,Home_Loc_Y,Work_Loc_X,Work_Loc_Y))

final_df <- subset(final_df, select = -c(Penalty_201407,Penalty_201408,Penalty_201409,Penalty_201410,Penalty_201411,Penalty_201412,Penalty_201501,Penalty_201502,Penalty_201503,Penalty_201504,Penalty_201505,Penalty_201506))
